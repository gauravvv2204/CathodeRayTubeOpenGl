...
void timer(int value)
{
    ...
    drawArrow();
    if(arrowLevel>6) drawVerticalArrow();
}
...
void display() {
  ...
  glClear(GL_COLOR_BUFFER_BIT);
    ...
    float oldColor[3] = {br,bg,bb}; // light green
    floodFill(41,300,newColor,oldColor);
    ...
    oldColor[1] = bg;
    oldColor[2] = bb;
    floodFill(60,250,newColor,oldColor);
    //color electrons
    newColor[0] = 0.0;
    newColor[1] = 1.0;
    newColor[2] = 0.0;
    ...
    oldColor[1] = bg;
    oldColor[2] = bb;
    floodFill(105,250,newColor,oldColor);
    floodFill(125,250,newColor,oldColor);
    floodFill(145,250,newColor,oldColor);
    ...
    oldColor[1] = bg;
    oldColor[2] = bb;
    floodFill(471,266,newColor,oldColor);
    floodFill(545,270,newColor,oldColor);
    floodFill(590,295,newColor,oldColor);
    floodFill(475,230,newColor,oldColor);
    floodFill(545,230,newColor,oldColor);
    floodFill(590,195,newColor,oldColor);
    ...
    oldColor[1] = bg;
    oldColor[2] = bb;
    floodFill(680,290,newColor,oldColor);
    floodFill(750,290,newColor,oldColor);
    floodFill(680,240,newColor,oldColor);
    floodFill(760,240,newColor,oldColor);
    floodFill(780,270,newColor,oldColor);
    floodFill(790,230,newColor,oldColor);
    glPointSize(2.0);
         glutTimerFunc(blinkDuration, timer, 0);
    glutTimerFunc(blinkDuration, updateElapsedTime, 1);
    glutTimerFunc(2000,updateArrowLevel,2);
